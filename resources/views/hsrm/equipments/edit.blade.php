    ...
    <form action="{{ route('hsrm.equipments.update', $equipment) }}" method="POST" enctype="multipart/form-data" id="equipment-form">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Saat ini: {{ $equipment->pic->name ?? '-' }}. Biarkan "Otomatis" untuk menjadikan diri Anda PIC.</p>
            ...
            <div>
                ...
                <input type="date" name="expired_date" value="{{ old('expired_date', $equipment->expired_date?->format('Y-m-d')) }}" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 soft-border">
