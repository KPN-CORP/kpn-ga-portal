    ...
    <form action="{{ route('hsrm.certificates.update', $cert) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="expired_date" value="{{ old('expired_date', $cert->expired_date?->format('Y-m-d')) }}" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500">
