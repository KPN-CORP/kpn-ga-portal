                            ...
                            <ul x-show="open" x-collapse class="pl-8 space-y-1 mt-1">
                                <li>
                                    <a href="{{ route('apartemen.admin.dashboard') }}" 
                                       class="sidebar-link block p-2 rounded-lg text-gray-600 hover:bg-gray-50 {{ request()->routeIs('apartemen.admin.dashboard') ? 'active' : '' }}">
                                        Dashboard Admin
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('apartemen.admin.index') }}" 
                                       class="sidebar-link block p-2 rounded-lg text-gray-600 hover:bg-gray-50 {{ request()->routeIs('apartemen.admin.index') ? 'active' : '' }}">
                                        Permintaan
                                        @php
                                ...
                                <li>
                                    <a href="{{ route('apartemen.admin.apartemen') }}" 
                                       class="sidebar-link block p-2 rounded-lg text-gray-600 hover:bg-gray-50 {{ request()->routeIs('apartemen.admin.apartemen*') ? 'active' : '' }}">
                                        Unit
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('apartemen.admin.monitoring') }}" 
                                       class="sidebar-link block p-2 rounded-lg text-gray-600 hover:bg-gray-50 {{ request()->routeIs('apartemen.admin.monitoring') ? 'active' : '' }}">
                                        Penghuni Aktif
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('apartemen.admin.history') }}" 
                                       class="sidebar-link block p-2 rounded-lg text-gray-600 hover:bg-gray-50 {{ request()->routeIs('apartemen.admin.history') ? 'active' : '' }}">
                                        Riwayat
                                    </a>
                                </li>
                            </ul>
