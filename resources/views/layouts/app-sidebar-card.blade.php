        ...
        <aside class="sidebar w-64 bg-white fixed h-full soft-shadow-sidebar">
            ...
            <div class="p-6 soft-border-bottom flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 opacity-80">ID Card</p>
                </div>
            </div>
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    ...
                    <!-- Semua Request -->
                    <li>
                        <a href="{{ url('/idcard') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard') || request()->is('idcard/*') ? 'active' : '' }}">
                    ...
                    <!-- Aktif -->
                    <li>
                        <a href="{{ url('/idcard/aktif') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard/aktif*') ? 'active' : '' }}">
                            <i class="fas fa-check-circle mr-3 text-green-500 opacity-70"></i>
                            <span>Aktif</span>
                            @php
                                $user = auth()->user();
                            ...
                            @endphp
                            @if($aktifCount > 0)
                                <span class="ml-auto bg-green-100 text-green-800 text-xs px-2 py-0.5 rounded-full">{{ $aktifCount }}</span>
                            @endif
                        </a>
                    </li>
                    ...
                    <!-- Inaktif -->
                    <li>
                        <a href="{{ url('/idcard/inaktif') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard/inaktif*') ? 'active' : '' }}">
                            <i class="fas fa-times-circle mr-3 text-red-500 opacity-70"></i>
                            <span>Inaktif</span>
                            @php
                            ...
                            @endphp
                            @if($inaktifCount > 0)
                                <span class="ml-auto bg-red-100 text-red-800 text-xs px-2 py-0.5 rounded-full">{{ $inaktifCount }}</span>
                            @endif
                        </a>
                    </li>
                    ...
                    <!-- Grafik -->
                    <li>
                        <a href="{{ url('/idcard/grafik') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard/grafik*') ? 'active' : '' }}">
                            <i class="fas fa-chart-bar mr-3 text-blue-500 opacity-70"></i>
                            <span>Grafik</span>
                        </a>
                    </li>
                    ...
                    <!-- Report -->
                    <li>
                        <a href="{{ url('/idcard/report') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard/report*') ? 'active' : '' }}">
                            <i class="fas fa-file-alt mr-3 text-purple-500 opacity-70"></i>
                            <span>Report</span>
                        </a>
                    </li>
