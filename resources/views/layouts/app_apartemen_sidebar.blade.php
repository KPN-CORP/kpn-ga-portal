        ...
        <aside class="sidebar w-64 bg-white fixed h-full soft-shadow-sidebar overflow-y-auto overflow-x-visible">
            ...
            <nav class="p-3 pb-24">
                ...
                <ul class="space-y-1">
                    ...
                    @endif
                    <li>
                        <a href="{{ route('apartemen.user.index') }}" title="Status Aktif"
                    ...
                    <li>
                        <a href="{{ route('apartemen.user.daftar') }}" title="Daftar Apartemen"
                           class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->routeIs('apartemen.user.daftar*') ? 'active' : '' }}">
                            <i class="fas fa-building w-5 mr-3 text-gray-400"></i>
                            <span>Daftar Apartemen</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('apartemen.user.requests') }}" title="Riwayat Permintaan"
                    ...
                    <li>
                        <a href="{{ route('apartemen.user.create') }}" title="Pengajuan Baru"
            ...
            <div class="absolute bottom-0 left-0 right-0 p-3 soft-border-top border-t bg-white"
                ...
                <button @click="openProfile = !openProfile" class="w-full flex items-center space-x-3 p-1 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <div class="min-w-0 text-left flex-1">
                        ...
                        <p class="text-xs text-gray-500 truncate">Penghuni</p>
                    </div>
