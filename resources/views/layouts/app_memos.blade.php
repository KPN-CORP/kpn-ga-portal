    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar w-64 bg-white fixed h-full soft-shadow-sidebar overflow-y-auto overflow-x-visible">
            ...
            <div class="p-5 soft-border-bottom border-b flex items-center gap-2">
                <div class="flex items-center space-x-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs text-gray-500 tracking-wide">E-Memo</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-3 pb-24">
                ...
                <p class="mt-5 mb-1 px-3 text-[11px] font-semibold text-gray-400 uppercase nav-label">E-Memo</p>
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('memos.index') }}" title="Semua Memo"
                    ...
                    <li>
                        <a href="{{ route('memos.create') }}" title="Buat Memo Baru"
