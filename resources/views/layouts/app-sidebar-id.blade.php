        ...
        <aside class="sidebar w-64 bg-white fixed h-full soft-shadow-sidebar">
            ...
            <div class="p-6 soft-border-bottom flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 opacity-80">ID Card Management</p>
                </div>
            </div>
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('idcard') }}" class="sidebar-link flex items-center p-3 rounded-lg text-gray-700 {{ request()->is('idcard*') ? 'active' : '' }}">
                            <i class="fas fa-id-card mr-3 text-gray-500 opacity-70"></i>
                            <span>ID Card</span>
                        </a>
                    </li>
