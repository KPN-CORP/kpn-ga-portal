...
<div class="container mx-auto max-w-2xl">
    <h1 class="text-2xl font-bold mb-4">Edit Log</h1>
    ...
    <form action="{{ route('drms.fuel-logs.update', $log->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="fuel_total_price" value="{{ old('fuel_total_price', $log->fuel_liters * $log->fuel_price_per_liter) }}" class="w-full border rounded px-3 py-2" min="0" step="0.01" required>
            </div>
        </div>
