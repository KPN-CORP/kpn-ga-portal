            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        {{-- Kolom Nominal disembunyikan sesuai permintaan --}}
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Diberikan Pada</th>
                        @if($isSpecialBu ?? false)
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if($usage)
                                <span class="text-sm text-gray-700">{{ $usage['requester_name'] }}</span>
                            @else
                                <span class="text-gray-400 text-sm">-</span>
                            @endif
                        </td>
                        <td class="px-6 py-4">
                            @if($usage && $usage['given_at'])
                                <span class="text-sm text-gray-700">{{ $usage['given_at']->format('d M Y H:i') }}</span>
                            @else
                                <span class="text-gray-400 text-sm">-</span>
                            @endif
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ ($isSpecialBu ?? false) ? 8 : 7 }}" class="px-6 py-10 text-center text-gray-500">
