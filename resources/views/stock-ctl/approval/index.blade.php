...
<div class="space-y-6 text-sm text-gray-800 font-sans">
    <div>
        <h2 class="text-xl font-semibold text-gray-800">Approval Permintaan</h2>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">{{ number_format($item->jumlah, 2) }} {{ $item->barang->satuan ?? '' }}</td>
...
function showApproveModal(id) {
    ...
    form.action = "{{ url('stock-ctl/approval') }}/" + id + "/approve";
...
function showRejectModal(id) {
    ...
    form.action = "{{ url('stock-ctl/approval') }}/" + id + "/reject";
