        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 @error('area_id') border-red-500 @enderror @if($lockedArea) bg-gray-100 text-gray-600 cursor-not-allowed @endif"
            ...
            <div>
                ...
                <select name="pic_user_id" id="pic_user_id" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500">
