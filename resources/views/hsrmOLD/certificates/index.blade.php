    ...
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="p-3">
                    <div class="max-w-[200px] whitespace-normal break-words">{{ $cert->employee_name }}</div>
                </td>
            ...
            @empty
            <tr><td colspan="9" class="p-4 text-center text-gray-500">No certificates found.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
