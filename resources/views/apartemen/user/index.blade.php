        ...
        <div class="p-4 md:p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="text-sm text-gray-600">
                    Total: {{ $activeAssignments->count() }} status aktif
                </div>
            </div>
        </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-2 pl-8">
                                    ...
                                    <!-- <div class="flex items-center text-sm text-gray-700">
                                        ...
                                        <span>Periode: {{ $assignment->periode }}</span>
                                    </div> -->
                                    <div class="flex items-center text-sm text-gray-700">
                                        <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 gap-4 text-sm">
        <div>
            ...
            <div class="font-semibold text-gray-900">
                {{ \Carbon\Carbon::parse($assignment->tanggal_mulai)->format('d M Y') }}
            </div>
        </div>
        <div>
            <div class="text-gray-600 mb-1 text-xs font-medium">Selesai</div>
            <div class="font-semibold text-gray-900">
                {{ \Carbon\Carbon::parse($assignment->tanggal_selesai)->format('d M Y') }}
            </div>
        </div>
        <div class="col-span-2 mt-3">
            <div class="flex items-center justify-between p-3 rounded-lg" id="sisa-waktu-{{ $assignment->id }}">
            ...
            <div class="mt-2">
                ...
                <div class="flex justify-between text-xs text-gray-500 mt-1">
                    ...
                    <span>
                        ...
                        @else
                            {{ floor($hariTersisa) }} hari tersisa
                        @endif
                    </span>
                </div>
            </div>
