...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // 🔥 Muat helper terbilang() agar tersedia di semua view dan controller
        // Ini akan selalu berhasil tanpa perlu mengubah composer.json
        if (file_exists(app_path('Helpers/helpers.php'))) {
            require_once app_path('Helpers/helpers.php');
        }

        // 🔥 HTTPS: aktifkan hanya jika bukan environment lokal (production)
